...
CATEGORY_KEYWORDS = {
    '가방': [
        ...
        '도핀', 'dauphine', '클루니', 'cluny', '트위스트', 'twist',
        '락미', 'lockme', '니스', 'nice', '삭플라', 'sac plat',
        '에스트렐라', 'estrela', '다이앤', 'diane', '팜스프링스', 'palm springs',
        '파시', 'passy', '크로아제트', 'croisette', '부시', 'buci',
        '에튀', 'etui', '토일렛', 'toiletry', '키리가미', 'kirigami',
        '파빌론', 'pavillon', '마렐', 'marelle', '뉴웨이브', 'new wave',
        '데일리 파우치', 'daily pouch', '쁘띠삭', 'petit sac',
        '월릿온체인', 'wallet on chain', 'woc',
    ],
    '지갑': [
        # 일반
        ...
        '포르트폴리오', 'portfolio', '엔벨로프', 'envelope',
        '코인퍼스', 'coin purse', '동전지갑', '포켓', 'pocket',
        '트위스트 지갑', '에피 지갑', '앙프렝뜨 지갑',
    ],
    '신발': [
        # 일반
    ...
    '의류': [
        ...
        '플리스', 'fleece', '데님 자켓', '데님 팬츠', '니트', 'knit',
        '반팔', '긴팔', '풀오버', 'pullover', '인따르시아', 'intarsia',
        '자카드', 'jacquard', '데그라데', 'degrade',
    ],
    '쥬얼리': [
        # 일반
        ...
        # 루이비통 특화
        '네크리스', 'necklace', '브레이슬릿', 'bracelet',
        '나노그램', 'nanogram', '에센셜v', 'essential v',
        '아이코닉', 'iconic', '모노그램 체인', '버질아블로',
    ],
    '패션 악세서리': [
        # 일반
        '벨트', '스카프', '머플러', '선글라스', '모자', '장갑', '넥타이',
        '포켓스퀘어', '브레이슬릿', '시계줄', '키링', '키체인',
        # 루이비통 특화
        '방도', 'bandeau', '비니', 'beanie', '실크스카프', 'silk scarf',
        '이니셜벨트', 'initiales', '리버시블벨트', 'reversible belt',
        '이클립스벨트', '퐁뇌프', 'pont neuf', '모노그램벨트',
        '선글라스', '모자', '캡', 'cap', '햇', 'hat',
    ],
}
