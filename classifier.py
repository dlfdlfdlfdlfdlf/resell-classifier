...
CATEGORY_KEYWORDS = {
    '가방': {
        'include': [
            ...
            '툴룸', '사포', '마리그난', '벨라', '벨로', '스티머',
            '에일린', '베를린', '파리', '런던', '뉴욕', '베이비백',
        ],
        'exclude': [
            '쇼핑백', '백참', '포장백', '선물백', '박스백',
    ...
    '지갑': {
        'include': [
            ...
            '코인퍼스', '키홀더', '머니클립',
            '엘렌월릿', '사라월릿', '빅토린', '로잘린',
            '포켓월릿', '제임스월릿', '리사월릿', '아메리고월릿',
            '윌릿', '빌릿', '클래식월릿', '컴팩트월릿', '트래블월릿',
        ],
        'exclude': [
            '백팩', '토트', '숄더백', '크로스백', '핸드백',
            '목걸이', '귀걸이', '팔찌',
    ...
    '신발': {
        'include': [
            ...
            '샌달', '쪼리', '어그',
            '러너', '런어웨이', '트레킹', '하이탑',
            '런웨이', '웨지', '앵글', '부티', '에스파드류', '모카신',
            '플립플롭', '크록스', '비치슈즈', '워커', '하이킹슈즈',
        ],
        'exclude': [
            '가방', '지갑',
        ]
    ...
    '의류': {
        'include': [
            ...
            '카라티', '포켓티',
            '바람막이',
            '셋업', '후디', '조끼', '트랙탑', '크롭티', '드로즈', '속옷',
            '무스탕', '패딩조끼', '베스트', '니트베스트', '가운', '로브',
            '파자마', '잠옷', '홈웨어', '한복', '교복', '작업복',
        ],
        'exclude': [
            '가방', '지갑', '신발', '슈즈',
        ]
    ...
    '쥬얼리': {
        'include': [
            ...
            # ── 추가 키워드 ──────────────────────────────────────
            '뱅글', '링', '발찌', '펜던트', '초커', '체인목걸이', '십자가목걸이',
            '진주목걸이', '커플링', '우정링', '실버링', '금반지', '다이아반지',
            '귀찌', '피어싱', '쥬얼리세트', '보석함', '보석케이스',
        ],
        'exclude': [
            '체인백', '체인가방', '체인스트랩', '반지갑',
            '가방', '지갑', '신발',
    ...
    '패션악세서리': {
        'include': [
            ...
            '양말', '스타킹',
            '목도리',
            '숄', '트윌리', '반도', '헤어악세서리', '벨트백', '힙색',
            '넥케이스', '카드케이스', '명함케이스', '여권케이스',
            '지갑체인', '에어팟케이스', '버즈케이스',
            '휴대폰케이스', '폰케이스', '그립톡', '스트랩',
        ],
        'exclude': [
    ...
    '기타': {
        'include': [
            ...
            '순금', '골드', '금장',
            '하이브',
            '립밤', '액자', '방석', '인형', '스피커', '애견용품',
            '볼펜', '연필', '수첩',
            '우드트레이', '쟁반', '꽃병', '화병', '리드디퓨저', '룸스프레이',
            '핸드크림', '바디로션', '샴푸', '컨디셔너', '비누', '클렌징',
            '마스크팩', '화장품', '스킨케어', '메이크업', '네일',
            '마스크', '손소독제', '체온계', '구급함',
            '카시트', '유모차', '아기띠', '젖병', '장난감',
            '캠핑용품', '랜턴', '침낭', '테이블', '의자',
        ],
